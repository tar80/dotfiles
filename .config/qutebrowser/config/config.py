...
## Type: Dict
c.bindings.key_mappings = {'<Ctrl-[>': '<Escape>', '<Ctrl-l>': '<F5>', '<Ctrl-M>': '<Return>', '<Ctrl-J>': '<Return>', '<Ctrl-I>': '<Tab>', '<Enter>': '<Return>', '<Shift-Enter>': '<Return>', '<Ctrl-Enter>': '<Ctrl-Return>'}
...
c.completion.cmd_history_max_items = 80
...
## Type: Int
c.completion.scrollbar.width = 25
...
c.completion.web_history.max_items = 60
...
c.content.blocking.adblock.lists = [
        'https://filters.adtidy.org/windows/filters/18_optimized.txt', #cookies Adguard for windows
        ...
        'https://raw.githubusercontent.com/Yuki2718/adblock2/main/japanese/jpfp-ub.txt',
...
## Type: String
# NOTE: Some sites crash when this property is true. Or rather, qiita
...
## Type: String
c.content.headers.accept_language = 'ja,en;q=0.9,en-GB;q=0.8,en-US;q=0.7'
...
## default is used.
## Type: Directory
c.downloads.location.directory = 'D:\\Workspace'
...
c.fileselect.folder.command = ['D:\\Apps\\ppxdw64\\PPCW.EXE', '-single -bootid:t -choose:con8 {}']
...
# c.fileselect.multiple_files.command = ['D:\\Apps\\ppxdw64\\PPCW.EXE', '-single -bootid:t -choose:con8 {}']
...
# c.fileselect.single_file.command = ['D:\\Apps\\ppxdw64\\PPCW.EXE', '-single -bootid:t -choose:con8 {}']
...
c.fonts.default_family = ['Noto Sans JP']
...
## Type: Font
c.fonts.messages.error = 'default_size default_famyly'

## Font used for info messages.
## Type: Font
c.fonts.messages.info = 'default_size default_famyly'

## Font used for warning messages.
## Type: Font
c.fonts.messages.warning = 'default_size default_famyly'

## Font used for prompts.
## Type: Font
c.fonts.prompts = 'default_size , "FirgeNerd Console"'

## Font used in the statusbar.
## Type: Font
c.fonts.statusbar = 'default_size "FirgeNerd Console"'

## Font used for selected tabs.
## Type: Font
c.fonts.tabs.selected = 'default_size default_famyly'

## Font used for unselected tabs.
## Type: Font
c.fonts.tabs.unselected = 'default_size default_famyly'
...
## Type: FontFamily
c.fonts.web.family.fixed = 'PlemolJP Console NF'

## Font family for sans-serif fonts.
## Type: FontFamily
# c.fonts.web.family.sans_serif = 'Noto Sans JP'

## Font family for serif fonts.
## Type: FontFamily
c.fonts.web.family.serif = 'Noto Serif JP Medium'

## Font family for standard fonts.
## Type: FontFamily
c.fonts.web.family.standard = 'Noto Sans JP'
...
c.hints.border = '1px solid #5AC8D2'

## Characters used for hint strings.
## Type: UniqueCharString
c.hints.chars = 'asdfgwert'
...
## hints.
## Type: Dict
c.hints.selectors = {'all': ['a', 'area', 'textarea', 'select', 'input:not([type="hidden"])', 'button', 'img', 'link', 'summary', '[contenteditable]:not([contenteditable="false"])', '[onclick]', '[onmousedown]', '[role="link"]', '[role="option"]', '[role="button"]', '[ng-click]', '[ngClick]', '[data-ng-click]', '[x-ng-click]', '[tabindex]'], 'links': ['a[href]', 'area[href]', 'link[href]', '[role="link"][href]'], 'images': ['img'], 'media': ['audio', 'img', 'video'], 'url': ['[src]', '[href]'], 'inputs': ['input[type="text"]', 'input[type="date"]', 'input[type="datetime-local"]', 'input[type="email"]', 'input[type="month"]', 'input[type="number"]', 'input[type="password"]', 'input[type="search"]', 'input[type="tel"]', 'input[type="time"]', 'input[type="url"]', 'input[type="week"]', 'input:not([type])', '[contenteditable]:not([contenteditable="false"])', 'textarea'], 'focus': ['frame', 'iframe']}
...
c.tabs.indicator.padding = {'top': 6, 'bottom': 4, 'left': 4, 'right': 8}
...
c.tabs.padding = {'top': 0, 'bottom': 2, 'left': 8, 'right': 4}
...
## Type: Dict
c.url.searchengines = {
        'DEFAULT': 'https://duckduckgo.com/?kl=jp-jp&kad=ja_JP&kp=-2&kz=-1&kc=-1&k1=-1&kk=-1&kaj=m&kak=-1&kax=-1&kaq=-1&kap=-1&kao=-1&kau=-1&ko=-1&kt=Yu+Gothic+UI&kae=-1&ka=Yu+Gothic+UI&q={}',
        ...
        's': 'https://www.startpage.com/sp/search?query={}&cat=web&pl=opensearch&language=japanese',
