...
config.bind(';e', 'hint links spawn "C:/Program Files (x86)/Microsoft/Edge/Application/msedge.exe" --window-size=800,600 --inprivate {hint-url}')
config.bind(';E', 'spawn "C:/Program Files (x86)/Microsoft/Edge/Application/msedge.exe" --window-size=800,600 --inprivate {url}')
config.bind(';p', 'hint links spawn gallery-dl {hint-url}')
config.bind(';P', 'spawn gallery-dl {url}')
...
# config.bind('<F1>', 'spawn C:/bin/cltc/cltc.exe')
config.bind('<F9>', 'config-edit')
config.bind('<Ctrl-F9>', 'config-source')
...
config.bind('<Ctrl-Ins>', 'yank selection', mode='insert')
