...
return {
  ...
  keys = {
    { key = 'Enter', mods = S, action = act.SendString('\x1b[13;2u') },
    { key = 'Enter', mods = C, action = act.SendString('\x1b[13;5u') },
    { key = ',', mods = C, action = act.SendString('\x1b[44;5u') },
    { key = '.', mods = C, action = act.SendString('\x1b[46;5u') },
    -- { key = '@', mods = 'CTRL', action = act.SendString('\x1b[64;5u') },
